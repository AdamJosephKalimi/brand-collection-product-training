...
class PresentationGenerationService:
    ...
    def _append_sales_talk(self, tf, item: dict, font_size: int = 12):
        """
        Append sales talk as paragraphs at the end of an existing text frame.

        Renders bold, slightly larger than surrounding text, right after
